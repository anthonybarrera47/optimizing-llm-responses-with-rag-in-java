...
public interface ChatAssistant {
     ...
     */
    default Stream<String> askQuestion(String conversationId,String message, boolean stream) {
        if (stream) {
            return streamResponse(conversationId,message);
        } else {
            return Stream.of(getResponse(conversationId,message));
        }
    }
